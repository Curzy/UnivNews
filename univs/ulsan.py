...
async def get_list(session):
    prefix_url = "http://iphak.ulsan.ac.kr"
    notice_url = prefix_url + "/boardCnts/list.do?boardID=1006&m=0403&s=iphak"
    ...
    for notice in bs.find('tbody').find_all('tr'):
        ...
        data = univ_info2dict("울산대", anchor.text.strip(), prefix_url, link)
